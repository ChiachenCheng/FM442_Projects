...
data <- read.csv(file = "D:/Desktop/FM442/Presentation/R_code/SP500_2007_2008.csv")
head(data)
...
plot(dates[start:end], VaRdata$EWMA_VaR[start:end], type = "l", main = "EWMA VaR with violations",)
